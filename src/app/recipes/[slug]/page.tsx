...
export default function RecipePage() {
  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="print-hide mx-auto max-w-6xl px-4 pt-6 pb-2 sm:px-6 lg:px-8">
              ...
              <div>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <button
                    ...
                    className="print-hide shrink-0 flex h-7 w-7 items-center justify-center rounded-lg text-slate/40 hover:bg-cream-dark/30 hover:text-charcoal transition-colors cursor-pointer"
                ...
                <Link
                  ...
                  className="print-hide mt-3 inline-flex items-center gap-1.5 rounded-lg bg-terracotta/10 px-3 py-1.5 font-sans text-xs font-medium text-terracotta hover:bg-terracotta/20 transition-colors"
                >
                  <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5">
